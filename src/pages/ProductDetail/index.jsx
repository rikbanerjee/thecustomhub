          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-12">
            ...
            <div className="animate-fade-in" style={{ animationDelay: '100ms' }}>
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-2 font-bold py-3.5 px-6 rounded-xl transition-all ${
                      addedToCart
                        ...
                        : 'bg-accent hover:bg-yellow-600 text-primary-800'
                    }`}
                  >
                    {addedToCart ? (
                      <>
              ...
              <div className="space-y-3 mb-6">
                ...
                <a
                  href={`https://wa.me/15087334489?text=${encodeURIComponent(`Hi! I'm interested in ordering ${product.title} from TheCustomHub. Could you help me with the order. Thanks.`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
