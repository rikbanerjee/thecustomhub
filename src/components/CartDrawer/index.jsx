          ...
          <div className="border-t border-gray-200 px-6 py-4 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link
                to="/cart"
                onClick={closeDrawer}
                className="flex items-center justify-center border border-primary-600 text-primary-600 hover:bg-primary-50 font-semibold py-2.5 px-4 rounded-lg transition-colors text-sm"
              >
                View Cart
              </Link>
              <button
                ...
                className="flex items-center justify-center bg-primary-600 hover:bg-primary-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold py-2.5 px-4 rounded-lg transition-colors text-sm gap-2"
              >
                {checkoutLoading ? (
                  <>
